...
class WallFollow:
	...
	global last_turn_correction
        ...
        drive_msg.drive.speed = velocity - max(abs(turn_factor*angle), last_turn_correction)
	last_turn_correction = max(last_turn_correction-turn_decay_rate, abs(turn_factor*angle))
