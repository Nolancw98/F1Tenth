...
class reactive_follow_gap:
    ...
    def find_best_point(self, proc_ranges, data):
        ...
        neg_limit_idx = (np.abs(angle_array + math.radians(80))).argmin()
        pos_limit_idx = (np.abs(angle_array - math.radians(80))).argmin()
	...
	topspeed = 7.0
        ...
        #  targetspeed = 1.5 * proc_ranges[proc_ranges.size/2] - 4.25
          ...
          targetspeed = min(prev_targetspeed+0.005, topspeed - ((6.0/topspeed) * (8.0 - best_point["range"])))
          prev_targetspeed = min(prev_targetspeed+0.005, targetspeed)
