...
# Lab 3 Wall Follow Algorithm (Car Version)
...
class WallFollow:
	...
	global last_turn_correction
        ...
        drive_msg.drive.speed = max(velocity - max(abs(turn_factor*angle), last_turn_correction),1) # reduce speed when steering error is high (i.e. slow down in turns)
    ...
    def followLeft(self, data, leftDist):
        ...
        a = self.getRange(data, math.pi/12) #15 degrees
        b = self.getRange(data, 1.3) #~75 degrees
